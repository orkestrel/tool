...
| `@orkestrel/agent`      | `0.0.23` | L5    | `@orkestrel/abort` `^0.0.10`, `@orkestrel/budget` `^0.0.10`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/database` `^0.0.14`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/queue` `^0.0.13`, `@orkestrel/timeout` `^0.0.10`, `@orkestrel/tool` `^0.0.15`, `@orkestrel/workflow` `^0.0.18`, `@orkestrel/workspace` `^0.0.8` |                                                                |
...
| `@orkestrel/ollama`     | `0.0.17` | L6    | `@orkestrel/tool` `^0.0.15`, `@orkestrel/agent` `^0.0.23`, `@orkestrel/budget` `^0.0.10`, `@orkestrel/ndjson` `^0.0.10`, `@orkestrel/contract` `^0.0.17`                                                                                                                                                                   |                                                                |
...
| `@orkestrel/scaffold`   | `0.0.69` | L3    | `@orkestrel/console` `^0.0.13`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/markdown` `^0.0.14`, `@orkestrel/process` `^0.0.12`, `@orkestrel/template` `^0.0.7`                                                                                                                           |                                                                |
...
| `@orkestrel/tool`       | `0.0.15` | L2    | `@orkestrel/emitter` `^0.0.10`, `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                                                                                            |                                                                |
